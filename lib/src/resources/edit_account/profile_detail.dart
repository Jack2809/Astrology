...
import '../zodiac&natal_chart&horoscope/natal_chart_profile.dart';
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: !widget.item.gender?Color.fromRGBO(116,55, 245,1):Color.fromRGBO(38, 30, 63, 1),
                    ...
                    Container(
                      ...
                      width: size.width *0.43 ,
                      decoration: BoxDecoration(
                        color: widget.item.gender?Color.fromRGBO(255,74,183,1):Color.fromRGBO(38, 30, 63, 1),
                        borderRadius: BorderRadius.circular(10.0),
                        border: Border.all(color: Colors.white70),
                      ),
                      child:Row(
